                ...
                <KeyboardAwareScrollView>
                    <View flexDirection="row" alignItems="center" justifyContent="center">
                        <TouchableOpacity 
                            ...
                            <Text style={isCreatingGroup ? styles.mainText : styles.otherText}>Create Group</Text>
                        </TouchableOpacity>
                        <TouchableOpacity 
                            style={!isCreatingGroup ? styles.clickBox : styles.otherBox} 
                            onPress={() => setIsCreatingGroup(false)}>
                            <Text style={!isCreatingGroup ? styles.mainText : styles.otherText}>Join Group</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <TitleText>{isCreatingGroup ? 'Set a password:' : 'Enter password:'}</TitleText>
                    <View style={styles.phoneNumberBox}>
                        <TextInput
                            style={styles.nameInput}
                            ref={secondBox}
